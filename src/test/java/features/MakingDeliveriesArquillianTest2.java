...
@CucumberOptions(features = "src/test/resources/features/MakingDeliveriesFR2.feature")
@Transactional(TransactionMode.COMMIT)
public class MakingDeliveriesArquillianTest2 extends AbstractDeliveryTest implements Fr {
